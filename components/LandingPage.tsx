  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-[#002820] font-sans text-white flex flex-col">
            ...
            <nav className="hidden md:flex space-x-8">
              {["Risk Engine", "Digital Twin", "KARMA Index"].map((item) => (
                <a
                  key={item}
                  href="#"
                  className="text-slate-400 hover:text-green-400 font-medium text-sm transition-colors duration-200"
                >
                  {item}
                </a>
              ))}
              <a
                href="#"
                className="text-slate-400 hover:text-green-400 font-medium text-sm transition-colors duration-200 flex items-center gap-1.5"
              >
                AI Genie{" "}
              ...
              <a
                href="#"
                className="text-green-400 font-semibold text-sm border-b border-green-500 pb-0.5"
              >
                Battery Passport
              </a>
            </nav>
      ...
      <main className="flex-1 flex items-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-10 md:py-14 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight leading-snug mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-100 to-slate-300">
                India's trusted battery passport infrastructure for the EV
                ecosystem.
              </h1>

              {/* Subtitle */}
              <p className="text-base text-slate-400 mb-10 leading-relaxed max-w-lg mx-auto lg:mx-0">
                A blockchain-powered platform that creates a unique digital
                identity for every lithium-ion battery — enabling transparent
                tracking, real-time diagnostics, and lifecycle management from
                manufacturing to second-life and recycling.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {[
                  ...
                  >
                    <div
                      className={`w-11 h-11 ${bg} border rounded-xl flex items-center justify-center ${color}`}
                    >
                      <Icon size={20} />
                    </div>
                    <span className="text-xs font-semibold text-slate-300 text-center lg:text-left leading-tight whitespace-pre-line">
                      {label}
                    </span>
                  </div>
                ))}
            ...
            <div className="hidden lg:flex items-center justify-center relative">
              ...
              <div className="relative z-10 w-full max-w-[580px]">
                <img
                  src="/ChatGPT Image Mar 12, 2026, 01_04_59 PM-modified.png"
      ...
      <div className="border-t border-white/5 bg-slate-950/60 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 text-center">
            {[
              { value: "10K+", label: "Batteries Tracked" },
      ...
      <footer className="border-t border-white/5 py-6 bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-600 text-sm">
            &copy; 2025 E-Chargeup Solutions Pvt. Ltd. All rights reserved.
          </p>
