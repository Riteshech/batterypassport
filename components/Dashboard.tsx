            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        />
                        <span className="text-white/20 text-xl font-light hidden md:inline">|</span>
                        <span className="font-semibold text-slate-400 text-sm hidden md:inline">Battery Passport</span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="relative text-slate-500 hover:text-slate-300 transition-colors">
                        <Bell size={18} />
                        {isLoggedIn && <span className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-red-500 rounded-full border-2 border-slate-900"></span>}
                    </button>

                    <div className="flex items-center gap-3 pl-1">
                        <div className={`h-8 w-8 rounded-full flex items-center justify-center border ${isLoggedIn || isDemo ? 'bg-green-600/20 border-green-500/30 text-green-400' : 'bg-white/5 border-white/10 text-slate-500'}`}>
                            <User size={16} />
                        </div>
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 relative z-10">
            ...
            <div className="animate-fade-in-up">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-xs font-bold text-slate-600 uppercase tracking-widest">Advanced Telemetry & Compliance</span>
                    <div className="h-px flex-1 bg-white/5"></div>
                </div>
            ...
            <div className="mt-12 text-center text-sm text-slate-600 pb-8 border-t border-white/5 pt-8">
                <p className="mb-2">&copy; 2025 Chargeup Energy. Blockchain Ledger ID: <span className="font-mono text-slate-500">0x7f...3a2b</span></p>
